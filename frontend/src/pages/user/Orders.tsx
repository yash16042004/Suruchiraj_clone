...
const Orders: React.FC = () => {
  ...
  return (
    <div className="max-w-6xl mx-auto py-10 px-4">
      <h1 className="text-3xl font-bold mb-6 font-heading text-gray-800">My Orders</h1>
          ...
          <div className="grid gap-4">
            {orders.map((order) => (
              <div
                ...
                className="bg-white p-6 rounded-xl shadow-md border border-gray-200 cursor-pointer hover:shadow-lg transition-shadow"
              >
